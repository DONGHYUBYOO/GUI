...
public class CardLayout2 extends JFrame implements ActionListener {
	...
	private JButton mainBtn1, mainBtn2, mainBtn3, mainBtn4;
	...
	public CardLayout2() {
		...
		//네번째 카드에 보여줄 컴포넌트
		JButton btn4 = new JButton("네번째 카드-네번째 버튼");
		JLabel label1 = new JLabel("알콜 SODDI");		
		panel[3].setBackground(Color.PINK);
		panel[3].add(btn4);
		panel[3].add(label1);
	...
	public void actionPerformed(ActionEvent e) {
		...
		JPanel p = (JPanel) getContentPane().getComponent(1);	//Top에 붙인 패널이 0번째 이다
